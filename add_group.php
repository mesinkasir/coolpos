...
<img class="img-fluid" src="uploads/hips.png"/>
</div>
<div class="col-12 col-md-6 p-3 p-md-5">
     ...
     <?php echo display_msg($msg); ?>
      <form method="post" action="add_group.php" class="clearfix">
        <div class="form-group">
              <label for="name" class="control-label text-secondary">Group</label>
              <input type="name" class="form-control" name="group-name">
        </div>
        <div class="form-group">
              <label for="level" class="control-label text-secondary">Level</label>
        ...
        <div class="form-group clearfix">
                <button type="submit" name="add" class="btn btn-primary btn-lg col-12">Update</button>
        </div>
    </form>
</div>
</div>
